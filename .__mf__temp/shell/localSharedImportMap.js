...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
      ...
      ,
        "utility": async () => {
          let pkg = await import("__mf__virtual/shell__prebuild__utility__prebuild__.js")
          return pkg
        }
      ,
        "vue-router": async () => {
      ...
      ,
        "shared-components": async () => {
          let pkg = await import("__mf__virtual/shell__prebuild__shared_mf_2_components__prebuild__.js")
          return pkg
        }
      ,
        "@metronik/devextreme": async () => {
          let pkg = await import("__mf__virtual/shell__prebuild___mf_0_metronik_mf_1_devextreme__prebuild__.js")
          return pkg
        }
