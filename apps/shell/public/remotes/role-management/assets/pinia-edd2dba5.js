 ...
 */
const getActivePinia = () => (role_mf_2_management__loadShare__vue__loadShare__.hasInjectionContext() && role_mf_2_management__loadShare__vue__loadShare__.inject(piniaSymbol)) || activePinia;
...
function createPinia() {
    const scope = role_mf_2_management__loadShare__vue__loadShare__.effectScope(true);
    // NOTE: here we could check the window object for a state and directly set it
    // if there is anything like it with Vue 3 SSR
    const state = scope.run(() => role_mf_2_management__loadShare__vue__loadShare__.ref({}));
    let _p = [];
    // plugins added before calling app.use(pinia)
    let toBeInstalled = [];
    const pinia = role_mf_2_management__loadShare__vue__loadShare__.markRaw({
        install(app) {
...
function mergeReactiveObjects(target, patchToApply) {
    ...
    for (const key in patchToApply) {
        ...
        if (isPlainObject(targetValue) &&
            ...
            !role_mf_2_management__loadShare__vue__loadShare__.isRef(subPatch) &&
            !role_mf_2_management__loadShare__vue__loadShare__.isReactive(subPatch)) {
...
id, setup, setupOptions) {
    ...
    function useStore(pinia, hot) {
        ...
        pinia =
            ...
            (pinia) ||
                (hasContext ? role_mf_2_management__loadShare__vue__loadShare__.inject(piniaSymbol, null) : null);
        if (pinia)
            setActivePinia(pinia);
        pinia = activePinia;
        if (!pinia._s.has(id)) {
...
function storeToRefs(store) {
    const rawStore = role_mf_2_management__loadShare__vue__loadShare__.toRaw(store);
    const refs = {};
    for (const key in rawStore) {
        ...
        if (value.effect) {
            ...
            refs[key] =
                // ...
                role_mf_2_management__loadShare__vue__loadShare__.computed({
                    get: () => store[key],
                    set(value) {
                        store[key] = value;
                    },
        ...
        else if (role_mf_2_management__loadShare__vue__loadShare__.isRef(value) || role_mf_2_management__loadShare__vue__loadShare__.isReactive(value)) {
            // @ts-expect-error: the key is state or getter
            refs[key] =
                // ---
                role_mf_2_management__loadShare__vue__loadShare__.toRef(store, key);
        }
    }
    return refs;
}
...
//# sourceMappingURL=pinia-edd2dba5.js.map
