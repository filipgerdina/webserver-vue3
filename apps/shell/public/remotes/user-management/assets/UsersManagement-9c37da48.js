...
import { u as user_mf_2_management__loadShare__shared_mf_2_components__loadShare__, m as module } from './module-cea931b4.js';
...
const userRoles = new user_mf_2_management__loadShare__utility__loadShare__.Entity({
  entityCode: "USER_ROLES",
  module,
  dataSource: new user_mf_2_management__loadShare__utility__loadShare__.DataSource({
    name: "userRoles",
    method: "GET",
    translatableResponseFields: ["data.defaultPage"]
  })
});
const UserEntity = new user_mf_2_management__loadShare__utility__loadShare__.Entity({
  dataSource: new user_mf_2_management__loadShare__utility__loadShare__.DataSource({
    name: "users",
    method: "GET"
  }),
...
const _sfc_main = /* @__PURE__ */ user_mf_2_management__loadShare__vue__loadShare__.defineComponent({
  ...
  setup(__props) {
    const UserRolesDataGrid = user_mf_2_management__loadShare__vue__loadShare__.defineAsyncComponent(
      () => __vitePreload(() => import('./UserRolesDataGrid-6e4bc145.js'),true?["assets/UserRolesDataGrid-6e4bc145.js","assets/user_mf_2_management__loadShare__vue__loadShare__-2c98848e.js","assets/user_mf_2_management__mf_v__runtimeInit__mf_v__-df04a86b.js","assets/preload-helper-1a9bd443.js","assets/module-cea931b4.js","assets/user_mf_2_management__loadShare__utility__loadShare__-7f4d3c7b.js"]:void 0)
    );
    const pageStore = useUserManagementStore();
    return (_ctx, _cache) => {
...
//# sourceMappingURL=UsersManagement-9c37da48.js.map
