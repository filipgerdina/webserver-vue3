...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const UserRolesDataGrid = defineAsyncComponent(
      () => __vitePreload(() => import('./UserRolesDataGrid-c566e8bf.js'),true?["assets/UserRolesDataGrid-c566e8bf.js","assets/user_mf_2_management__loadShare__utility__loadShare__-319ee11e.js","assets/user_mf_2_management__mf_v__runtimeInit__mf_v__-df04a86b.js","assets/preload-helper-1a9bd443.js","assets/module-8931beaf.js"]:void 0)
    );
    const pageStore = useUserManagementStore();
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createVNode(_sfc_main$1),
        unref(user_mf_2_management__loadShare__utility__loadShare__.settingsService).activeModules.value.map((m) => m.moduleName).includes("rolesManagement") && unref(pageStore).usersDataGridStore.GetDataGridView()?.selectedRowKeys?.length ? (openBlock(), createBlock(unref(UserRolesDataGrid), { key: 0 })) : createCommentVNode("", true)
      ]);
    };
  }
});
...
//# sourceMappingURL=UsersManagement-ae2f625c.js.map
