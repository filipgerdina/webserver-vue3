...
const _sfc_main = /* @__PURE__ */ _defineComponent({
  ...
  setup(__props) {
    const UserRolesDataGrid = defineAsyncComponent(
      () => __vitePreload(() => import('./UserRolesDataGrid-c4869b2d.js'),true?["assets/UserRolesDataGrid-c4869b2d.js","assets/__federation_fn_import-054b33c3.js"]:void 0)
    );
    const pageStore = useUserManagementStore();
    return (_ctx, _cache) => {
...
export { GetRolesOfUserQueryDTOCoreListResponseFields as G, USER_ROLES_DATA_GRID as U, useUserManagementStore as a, _sfc_main as default, userEntity as u };
//# sourceMappingURL=__federation_expose_UsersManagement-fb9ebe3a.js.map
