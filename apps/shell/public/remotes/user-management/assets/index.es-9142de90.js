...
import { i as index_cjs$4, u as user_mf_2_management__mf_v__runtimeInit__mf_v__ } from './user_mf_2_management__mf_v__runtimeInit__mf_v__-df04a86b.js';

// dev uses dynamic import to separate chunks
    
    const {loadShare: loadShare$2} = index_cjs$4;
    const {initPromise: initPromise$1} = user_mf_2_management__mf_v__runtimeInit__mf_v__;
    const res$1 = initPromise$1.then(_ => loadShare$2("vue-router", {
    ...
    var user_mf_2_management__loadShare__vue_mf_2_router__loadShare__ = exportModule$1;

// dev uses dynamic import to separate chunks
    
    const {loadShare: loadShare$1} = index_cjs$4;
    const {initPromise} = user_mf_2_management__mf_v__runtimeInit__mf_v__;
    const res = initPromise.then(_ => loadShare$1("@metronik/devextreme", {
    customShareInfo: {shareConfig:{
      singleton: true,
      strictVersion: false,
...
export { DataSource as D, Entity as E, GetImageUrl as G, Module$1 as M, VisualizationType as V, authService as a, user_mf_2_management__loadShare___mf_0_metronik_mf_1_devextreme__loadShare__ as b, EndPointAction as c, loadRemoteModule as l, settingsService as s, translationService as t, user_mf_2_management__loadShare__vue_mf_2_router__loadShare__ as u };
//# sourceMappingURL=index.es-9142de90.js.map
